ServerEvents.genericLootTables((event) => {
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_1', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
        ...
        pool.addItem(Item.of('minecraft:enchanted_book', '{StoredEnchantments:[{id:"mysticalagriculture:mystical_enlightenment",lvl:1s}]}'));
  ...
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_2', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
  ...
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_3', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
  ...
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_4', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
  ...
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_5', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
  ...
  event.addGeneric(
    'lootbags:loot_tables/loot_bags/mystical_agriculture/seedbag_tier_6', (table) => {
      table.addPool((pool) => {
        pool.rolls = 1.0
